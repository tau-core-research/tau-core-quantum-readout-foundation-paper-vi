...
Existence is not unrestricted parent-law realization and occupation. Composing the construction with a
...
A8b member within this family. This is a genuine class-relative selector
theorem, but not yet an unrestricted physical-realization theorem: the
physical base--seed law has not been shown to require exact recovery on the
full occupied operator system. Restricted state
